        ...
        <div class="row">
            <div class="content-left col-3">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" v-model="compact"></textarea>
                </div>
                <div class="form-group">
                  <label for="virtues">Đức tính:</label>
                  <textarea class="form-control" rows="2" v-model="virtues"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="source" v-model="source" placeholder="Nguồn" >
                </div>
            </div>
            <div class="content-right col-9">
                <div class="name-title form-group">
                    <label for="usr">Tên tác phẩm:</label>
                    <input text="text" name="titlename" class="form-control" v-model="title_name">
                </div>
